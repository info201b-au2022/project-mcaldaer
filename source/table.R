...
print(total_count)
gender1 <- mutate(gender, Percentage = round((100.0 * Counts / total_count), 2))
print(gender1)
...
print(total_count)
race1 <- mutate(race, Percentage = round((100.0 * Counts / total_count), 2))
print(race1)
...
print(total_count)
precinct1 <- mutate(precinct, Percentage = round((100.0 * Counts / total_count), 2))
print(precinct1)
...
print(total_count)
resolution1 <- mutate(resolution, Percentage = round((100.0 * Counts / total_count), 2))
print(resolution1)
